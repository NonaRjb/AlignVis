...
from src.brain_architectures.atms_utils.Transformer_EncDec import Encoder, EncoderLayer
from src.brain_architectures.atms_utils.SelfAttention_Family import FullAttention, AttentionLayer
from src.brain_architectures.atms_utils.Embed import DataEmbedding
import numpy as np
...
class ATMS(nn.Module):    
    def __init__(self, num_latents=1024):
